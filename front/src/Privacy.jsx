...
const Privacy = () => (
  <div className="container">
    <div className="row">
      ...
      <p>
        safemeet.space (&quot;us&quot;, &quot;we&quot;, or &quot;our&quot;)
        operates the safemeet.space
        website and the safemeet.space mobile application (the &quot;Service&quot;).
      </p>

      <p>
        This page informs you of our policies regarding the collection, use, and
        disclosure of personal data when you use our Service and the choices you
        have associated with that data. This Privacy Policy for safemeet.space
        is powered by
        <a href="https://freeprivacypolicy.com/">
...
.
      ...
      <p>
        safemeet.space uses the collected data for various purposes:
      </p>
      <ul>
        <li>
...
Transfer Of Data
      ...
      <p>
        If you are located outside Mexico and choose to provide information to
        us, please note that we transfer the data, including Personal Data, to
        Mexico and process it there.
      </p>
      <p>
      ...
      <p>
        safemeet.space will take all steps reasonably necessary to ensure that
...
Legal Requirements
      ...
      <p>
        safemeet.space may disclose your Personal Data in the good faith belief
...
To comply with a legal obligation
        ...
        <li>
To protect and defend the rights or property of safemeet.space
        </li>
        <li>
...
Contact Us
      ...
      <ul>
        <li>
By email: roderik.ikana@gmail.com
        </li>
      </ul>
    </div>
  </div>
